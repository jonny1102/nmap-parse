...
class NmapTerminal(TerminalBase):
    ...
    settable = [constants.OPT_INCLUDE_PORTS, constants.OPT_SERVICE_FILTER, constants.OPT_PORT_FILTER, constants.OPT_HOST_FILTER, constants.OPT_ALIVE, constants.OPT_HAVE_PORTS, constants.OPT_VERBOSE, constants.OPT_RAW]
  ...
  \033[1;30mTip: Set quiet to true to only get raw command output (no headings)\033[1;m"""
    ...
    #endregion    import random, textwrap, os, argparse, re
import cmd2, tabulate
